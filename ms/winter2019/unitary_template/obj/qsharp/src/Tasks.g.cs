...
#line hidden
    ...
    public class ApplyToEach : Adjointable<(IAdjointable,QArray<Qubit>)>, ICallable
    {
        ...
        {
            var (op,x) = __in__;
#line 19 "/Users/korbenrusek/Documents/code/quantum_winter_2019/unitary_template/Tasks.qs"
            foreach (var ix in new Range(0L, (x.Length - 1L)))
#line hidden
            {
#line 20 "/Users/korbenrusek/Documents/code/quantum_winter_2019/unitary_template/Tasks.qs"
                op.Apply(x[ix]);
            }
