...
namespace Solution {
    ...
    operation Solve_Test () : Unit {
        EqualityFactI(Solve(identity), 0, "IxI should return 0");
        EqualityFactI(Solve(CNOT12), 1, "CNOT12 should return 1");
        EqualityFactI(Solve(CNOT21), 2, "CNOT21 should return 2");
        EqualityFactI(Solve(swap), 3, "SWAP should return 3");
    }
