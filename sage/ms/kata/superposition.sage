load("../../load_files.sage")
load_files(["solution.sage", "gates.sage", "measurement.sage"])
...
class SuperpositionTest(Solution):
  ...
  def test_05_superposition_basis(self):
    ...
    self.assert_signs(q, [(0, 1/2), (1, i/2), (2, -1/2), (3, -i/2)])
